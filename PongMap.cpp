...
{
	player1 = new Player(*assetManager.get_model(0), glm::vec3(0, 4, 20), glm::vec3(2.0f));
	player2 = new Player(*assetManager.get_model(0), glm::vec3(15, 4, 40), glm::vec3(2.0f));
	player3 = new Player(*assetManager.get_model(0), glm::vec3(0, 4, -20), glm::vec3(2.0f));
	player4 = new Player(*assetManager.get_model(0), glm::vec3(15, 4, -40), glm::vec3(2.0f));
}
