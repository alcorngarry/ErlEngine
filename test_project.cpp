...
//void diceRoll(Shader shader, Model die, Player player);
//
//float roll_dice();
//
...
//
//	//Player player1(backpack, shaderProgram, objectsInScene[0]);
//
...
//			if (i == totalMoves)
//			{
//				//player1.movePlayer(startTime, roll + 1, );
//			}
//		}
//
//		glUniform1i(glGetUniformLocation(shaderProgram.ID, "selected"), false);
//		
//		//dice mechanic
//		//diceRoll(shaderProgram, die, player1);
//
//		//move if dice rolled
//		//characterMove()
//
...
//		//int endPos;
//		//if (startPos + (roll + 1) > objectsInScene.size() -1)
//		//{
//
//		//	std::vector<glm::vec3> moves(objectsInScene.begin() + startPos, objectsInScene.begin() + (roll + 1));
//		//}
//		//else {
//			std::vector<glm::vec3> moves(objectsInScene.begin() + startPos, objectsInScene.begin() + (roll+1));
//		//}
//
//		player.movePlayer(startTime, roll, moves);
//		startPos = totalMoves;
//		totalMoves += roll + 1;
//		//fix view
